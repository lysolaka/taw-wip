...
tags(type: "twilight:wood_palettes", handler: (event: TagEvent.WoodPalettes) => void): void
...
registry(type: "twilight:biome_layer_type", handler: (event: Registry.BiomeLayerType) => void):void,
registry(type: "twilightforest:dwarf_rabbit_variant", handler: (event: Registry.DwarfRabbitVariant) => void):void,
registry(type: "twilightforest:enforcement", handler: (event: Registry.Enforcement) => void):void,
registry(type: "twilightforest:tiny_bird_variant", handler: (event: Registry.TinyBirdVariant) => void):void,
registry(type: "twilight:wood_palettes", handler: (event: Registry.WoodPalettes) => void):void,
registry(type: "twilight:biome_layer_stack", handler: (event: Registry.BiomeLayerStack) => void):void,
registry(type: "twilight:magic_paintings", handler: (event: Registry.MagicPaintings) => void):void,
registry(type: "forge:structure_modifier", handler: (event: Registry.StructureModifier) => void):void,
registry(type: "twilight:restrictions", handler: (event: Registry.Restrictions) => void):void,
